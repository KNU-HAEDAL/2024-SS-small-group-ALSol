...
def count_problem_source_code(): 
    ...
    # 회원의 정보를 수정합니다. 고은샘, 김성원, 김희수, 배현진, 박지영, 손시연, 오지은 최연우
    # 박지영, 배현진, 손시연,
    directory_list = ['ESKO', 'SWKIM', 'HSKIM', 'HJBAE', 'JYPARK', 'SYSON', 'JEOH', 'YWCHOI']
    language_cnt = []
    code_cnt_info = []
    total_code_cnt = []
...
def make_read_me(code_cnt_info, total_code_num, language_cnt, total_push_cnt):
    name_list = ['고은샘', '김성원', '김희수', '배현진', '박지영', '손시연', '오지은','최연우']
...
- `git clone "https://github.com/kdongsu5509/Haedal_24_1_AlgorithmStudy.git"`을 입력하여 저장소를 복제합니다.
